...
{
    return [self md5_32:str format:@"%02x"];
}
...
{
    NSString *md5_32Bit_String=[self md5_32:str format:@"%02x"];
...
+ (NSString *)md5_32:(NSString *)str format:(NSString *)format
{
    ...
    for(int i = 0; i < CC_MD5_DIGEST_LENGTH; i++)
        [result appendFormat:format, digest[i]];           // 小写x表示输出的是小写MD5，大写X表示输出的是大写 MD5
    return result;
}
@end
